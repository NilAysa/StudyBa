...
namespace StudyBaProject.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SubjectId,DepartmentId,SubjectName")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SubjectId,DepartmentId,SubjectName")] Subject subject)
        {
